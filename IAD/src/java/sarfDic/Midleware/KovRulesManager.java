...
import sarf.kov.QuadrilateralKovRuleList;
import sarf.kov.TrilateralKovRule;
import sarf.kov.TrilateralKovRuleList;
...
public class KovRulesManager {
    ...
    private String db_path=config.config.dbpath;
    ...
    private KovRulesManager() {
        try {
            trilateralRulesList = buildTrilateral(new File(db_path+"/Trilateralkov.xml"));
            quadrilateralRulesList = buildQuadrilateral(new File(db_path+"/Quadrilateralkov.xml"));
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        ...
        char c3 = 'ي';
        char c4 = 'ج';
        System.out.println(""+ KovRulesManager.getInstance().getTrilateralKov(c1,c2,c3)+", " + KovRulesManager.getInstance().getTrilateralKovRule(c1,c2,c3).getDesc());
