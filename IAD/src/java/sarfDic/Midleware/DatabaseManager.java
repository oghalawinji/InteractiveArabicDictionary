...
public class DatabaseManager {
    ...
    private String db_path=config.dbpath;
    ...
    public UnaugmentedTrilateralRootTree getUnaugmentedTrilateralRootTree(char c1) {
        ...
        if (rootsTree == null) {
            try {
                rootsTree = UnaugmentedTrilateralRootTreeCreator.buildXmlVerbTree(new File(db_path+"/trilateral/unaugmented/" + c1 + ".xml"));
    ...
    public AugmentedTrilateralRootTree getAugmentedTrilateralRootTree(char c1) {
        ...
        if (rootsTree == null) {
            try {
                rootsTree = AugmentedTrilateralRootTreeCreator.buildXmlVerbTree(new File(db_path+"/trilateral/augmented/" + c1 + ".xml"));
    ...
    public UnaugmentedQuadriliteralRootTree getUnaugmentedQuadriliteralRootTree(char c1) throws Exception{
        ...
        if (rootsTree == null) {
                ...
                rootsTree = UnaugmentedQuadriliteralRootTreeCreator.buildXmlVerbTree(new File(db_path+"/quadriliteral/unaugmented/" + c1 + ".xml"));
    ...
    public AugmentedQuadriliteralRootTree getAugmentedQuadriliteralRootTree(char c1) throws Exception{
        ...
        if (rootsTree == null) {
                ...
                rootsTree = AugmentedQuadriliteralRootTreeCreator.buildXmlVerbTree(new File(db_path+"/quadriliteral/augmented/" + c1 + ".xml"));
    ...
    public XmlNounFormulaTree getXmlNounFormulaTree(char c1, String folderName) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/"+folderName+"/" + c1 + ".xml");
                if (!file.exists())
    ...
    public XmlMeemGerundNounFormulaTree getMeemGerundFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/gerund/meem/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
    ...
    public AssimilateAdjectiveFormulaTree getAssimilateAdjectiveFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/assimilate/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
    ...
    public ElativeNounFormulaTree getElativeNounFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/elative/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
    ...
    public XmlNonStandardInstrumentalNounFormulaTree getInstrumentalNounFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/instrumental/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
    ...
    public XmExaggerationNounFormulaTree getExaggerationNounFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/exaggeration/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
    ...
    public XmlTimeAndPlaceNounFormulaTree getTimeAndPlaceNounFormulaTree(char c1) {
        ...
        if (formulaTree == null) {
            try {
                File file = new File(db_path+"/noun/timeandplace/" + c1 + ".xml");
                if (!file.exists())
                    //there is no applied file for this char
                    return null;
