...
/**
 * Helper to create predicate by example. It processes associated entities (1
 * level deep).
 */
...
public class ByExampleUtil {
    ...
    private EntityManager em = Persistence.createEntityManagerFactory(PersistencyConfig.PERSISTANCE_UNIT_NAME).createEntityManager();
